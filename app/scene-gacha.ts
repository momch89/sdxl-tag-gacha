...
const wardrobes: Record<Resolved['world'], Record<Resolved['clothing'], Wardrobe[]>> = {
  modern: {
    ...
    costume: [['school uniform','loafers'], ['school uniform','serafuku','sailor collar','neckerchief','pleated skirt','loafers'], ['business suit','collared shirt','necktie','pants','loafers'], ['business suit','suit jacket','shirt tucked in','black pants','loafers'], ['business suit','skirt suit','pencil skirt','collared shirt','shoes'], ['maid','maid headdress','frilled dress','apron','shoes'], ['maid','maid headdress','frilled dress','maid apron','puffy sleeves','shoes'], ['maid','maid headdress','black dress','frilled apron','puffy sleeves','shoes'], ['nurse','nurse cap','white dress','shoes'], ['chef','chef hat','shirt','pants','apron','shoes'], ['idol','frilled dress','boots'], ['police uniform','boots'], ['military uniform','boots'], ['lab coat','collared shirt','pants','shoes'], ['gym uniform','sneakers'], ['track suit','sneakers'], ['pajamas','slippers'], ['overalls','shirt','sneakers'], ['one-piece swimsuit','sandals'], ['bikini','sandals']],
  },
  fantasy: {
    ...
    costume: [['witch','witch hat','robe','boots'], ['witch','witch hat','dress','fur cloak','boots'], ['witch','witch hat','robe','broom','holding broom','boots'], ['witch','witch hat','robe','wand','boots'], ['magical girl','frilled dress','boots'], ['nun','habit','shoes'], ['maid','maid headdress','frilled dress','apron','shoes'], ['armor','tabard','boots'], ['gothic lolita','frilled dress','boots']],
  },
  japanese: {
    ...
    costume: [['miko','kimono','hakama','tabi','geta'], ['miko','white kimono','hakama skirt','wide sleeves','tabi','geta'], ['miko','white kimono','hakama skirt','ribbon-trimmed sleeves','tabi','geta'], ['ninja','japanese clothes','boots'], ['samurai','kimono','hakama','boots'], ['china dress','shoes'], ['school uniform','loafers'], ['school uniform','serafuku','sailor collar','neckerchief','pleated skirt','loafers']],
  },
  future: {
...
const backgrounds: Record<Resolved['world'], string[][]> = {
  modern: [['park','tree','outdoors'], ['garden','tree','sunlight'], ['street','cityscape','building'], ['rooftop','cityscape','sky'], ['classroom','window','indoors'], ['cafe','window','indoors'], ['train station','cityscape','building'], ['crosswalk','cityscape','road'], ['alley','city lights','building'], ['library','indoors'], ['beach','ocean','sky'], ['city','cityscape','building','road'], ['city','city lights','building','night']],
  fantasy: [['forest','tree','sunlight','outdoors'], ['forest','nature','river','rock'], ['forest','nature','moss','stream'], ['forest','nature','bush','scenery'], ['castle','stone wall','tower'], ['castle','architecture','bridge','cloud'], ['castle','moon','sky'], ['cave','crystal'], ['ruins','overgrown'], ['mountain','cloud'], ['lake','sunlight'], ['throne room','indoors'], ['floating city','cloud'], ['flower field','sunlight'], ['stone bridge','river']],
  japanese: [['shrine','lantern','outdoors'], ['shrine','east asian architecture','stairs','tree'], ['shrine','architecture','scenery','lantern'], ['temple','stone wall'], ['bamboo forest','sunlight'], ['bamboo forest','nature','outdoors'], ['onsen','mountain'], ['garden','lantern'], ['wooden bridge','river'], ['train station','cityscape'], ['beach','ocean'], ['flower field','sunlight']],
  future: [['city','city lights','building'], ['city','cityscape','road','skyline'], ['rooftop','cityscape','sky'], ['laboratory','monitor','indoors'], ['space station','space'], ['spacecraft interior','monitor'], ['server room','monitor','indoors'], ['floating city','cloud'], ['space elevator','cityscape'], ['industrial','cityscape'], ['underwater city','ocean']],
};
const moods: Record<Resolved['mood'], string[][]> = {
  cheerful: [['day','smile','closed mouth'], ['day','smile','open mouth','blush'], ['day','grin','open mouth'], ['day','happy','open mouth'], ['day','light smile','closed mouth','blush'], ['sunset','smile','parted lips'], ['day','laughing','open mouth','closed eyes'], ['day',':d','open mouth','blush']],
  calm: [['day','light smile','closed mouth'], ['sunset','smile','closed mouth'], ['day','expressionless','closed mouth'], ['sunset','light smile','half-closed eyes'], ['day','serious','closed mouth'], ['day','smile','closed mouth','blush']],
  dramatic: [['sunset','serious','parted lips'], ['night','angry','open mouth','anger vein'], ['night','angry','clenched teeth','v-shaped eyebrows'], ['night','angry','frown','glaring'], ['sunset','sad','tears','parted lips'], ['sunset','sad','tearing up','furrowed brow'], ['night','crying','crying with eyes open','tears','open mouth'], ['night','scowl','closed mouth'], ['sunset','annoyed','closed mouth'], ['sunset','worried','parted lips'], ['night','surprised','open mouth','wide-eyed'], ['night','surprised',':o','sweatdrop'], ['night','crying','tears','open mouth','closed eyes']],
