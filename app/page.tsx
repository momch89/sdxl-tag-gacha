...
export default function Home() {
  ...
  const shownTags = useMemo(() => {
    ...
    const filtered = allTags.filter(x => x.category.id === dictCategory && (!q || `${x.tag} ${x.ja}`.toLowerCase().includes(q)));
